...
If you don't want to fully build the image, just use the prebuild image ```docker pull ellerbach/tensor_pillow_flask``` you will find details on [Docker Hub](docker pull ellerbach/tensor_pillow_flask)
